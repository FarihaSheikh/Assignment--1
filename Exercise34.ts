...
// of the pizza. For each pizza you should have one lineof output containing a simple statement like I like pepperoni pizza.
...
let pizzas: string[]= ['Fajjita', 'Chicken Tikka', 'Malai Boti']
