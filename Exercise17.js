...
var Guest_list = ['Mahnoor Ali', 'Rozina Narejo', 'Shagufta Aslam'];
// for(let i=0;i<Guest_list.length;i++){
//     console.log('Dear Miss '+ Guest_list[i] + ',\n\nWe are greatful to invite you in our dinner party.\n\nThank You!\n\n')
// }
var person_not_Coming = 'Mahnoor Ali';
var new_Guest = 'Rabiya Ghazal';
Guest_list[0] = new_Guest;
// for(let i=0;i<Guest_list.length;i++){
//     console.log('Dear Miss '+ Guest_list[i] + ',\n\nWe are greatful to invite you in our dinner party.\n\nThank You!\n\n')
// }
console.log("Miss. ".concat(person_not_Coming, " is not coming to the party.\n\n"));
